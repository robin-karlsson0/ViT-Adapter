...
from .lseg_blocks import FeatureFusionBlock_custom, Interpolate, _make_encoder
...
class LSeg(BaseModel):
    ...
    def forward(self, x):
        ...
        path_1 = self.scratch.refinenet1(path_2, layer_1_rn)  # type: ignore
        ...
        cached_image_features = image_features.clone().detach()

        return cached_image_features
