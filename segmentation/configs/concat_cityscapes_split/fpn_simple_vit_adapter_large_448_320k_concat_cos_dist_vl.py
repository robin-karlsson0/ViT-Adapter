_base_ = [
    '../_base_/datasets/concat_cityscapes_split.py',
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(896, 448), ratio_range=(0.5, 1)),
...
runner = dict(type='IterBasedRunner')
evaluation = dict(interval=10000000000000000000000000000000,
                  metric='mIoU',
                  save_best='mIoU',
                  efficient_test=True)
