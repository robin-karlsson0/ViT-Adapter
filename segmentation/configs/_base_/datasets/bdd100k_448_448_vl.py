...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1792, 896), ratio_range=(0.5, 1)),
...
data = dict(samples_per_gpu=2,
            ...
            train=dict(type=dataset_type,
                       ...
                       ann_dir='labels/pan_seg/bitmasks/train',
                       pipeline=train_pipeline),
            val=dict(type=dataset_type,
                     data_root=data_root,
                     img_dir='images/10k/val',
                     ann_dir='labels/pan_seg/bitmasks/val',
