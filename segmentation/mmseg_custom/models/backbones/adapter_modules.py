...
class DWConv(nn.Module):
    ...
    def forward(self, x, H, W):
        ...
        x is split up into spatial feature maps [x1, x2, x3].

        Args:
            x: Concatenated spatial features [1/8, 1/16, 1/32] (actually 'c').
            H: Size of 1/16 SPM spatial feature convolution map.
            W:
        '''
        B, N, C = x.shape
        n = N // 21
