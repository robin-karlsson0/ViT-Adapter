...
from .cityscapes_vl import CityscapesVLDataset
...
class ConcatDataset(_ConcatDataset):
    ...
    def __init__(self, datasets, separate_eval=True):
        ...
        if any([isinstance(ds, CityscapesVLDataset) for ds in datasets]):
            raise NotImplementedError(
                'Evaluating ConcatDataset containing CityscapesVLDataset'
                'is not supported!')
